...
filtered_words = []
filler_words = ["how", "where", "like", "had", "here", "too", "its", "him", "be", "vs", "even", "very", "among", "those", "much", "all", "were", "from", "will", "been", "top", "several", "or", "out", "you", "up", "an", "over", "the", "with", "before", "was", "back", "has", "see", "ever", "now", "what", "could", "after", "on", "us", "more", "are", "have", "get", "as", "but", "be", "one", "who", "not", "by", "my", "can", "do", "that", "in", "to", "a", "is", "and", "of", "it", "for", "at", "our", "i", "about", "we", "this", "he", "she", "they"]
...
chart = alt.Chart(words_data).mark_bar().encode(
    x=alt.X('word', axis=alt.Axis(title='word')),
...
st.altair_chart(chart, use_container_width=True)
st.markdown("NOTE: An absence of a bar indicates that the headline is neutral.")
